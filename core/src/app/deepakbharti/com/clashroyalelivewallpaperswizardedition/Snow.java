...
public class Snow implements Screen {
    ...
    private void setquantities() {
        ...
        snowType = mpreferences.getString(""+100000002);
        ...
        this.particleEffect.load(Gdx.files.internal("ice_wiz_flame.p"),Gdx.files.internal(""));
        this.particleEffect.start();
        if(this.ln){
            this.particleEffect.scaleEffect(2f,2f,2);
            this.particleEffect.setPosition(((float) this.f1854W)/2.6f,((float) this.f1853H)/3.3f);
        }else{
            this.particleEffect.scaleEffect(2f,2f,2);
            this.particleEffect.setPosition(((float) this.f1854W)/2.3f,((float) this.f1853H)/3.9f);
        }

        this.back_6 = get_sprite(this.ln ? "ice_wiz_land.png" : "ice_wiz_port.png",
        ...
        this.snow1_6 = get_sprite(snowType, 0.0f, 0.0f, this.dim_6[0], this.dim_6[0]);
        this.snow2_6 = get_sprite(snowType, 0.0f, 0.0f, this.dim_6[1], this.dim_6[1]);
        this.snow3_6 = get_sprite(snowType, 0.0f, 0.0f, this.dim_6[2], this.dim_6[2]);
        this.snow4_6 = get_sprite(snowType, 0.0f, 0.0f, this.dim_6[3], this.dim_6[3]);
